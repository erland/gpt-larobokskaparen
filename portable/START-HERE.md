...
2. Använd filerna under `knowledge/` som primärt referensmaterial för arbetsflöde, pedagogik, bokstruktur, kvalitet, illustrationer och export.
3. Läs relevanta Knowledge-filer innan du utför en uppgift som berör deras område.
4. Behandla `examples/` som exempel och stödmaterial, inte som överordnade instruktioner.
5. Använd alltid användarens aktuella instruktioner tillsammans med paketets arbetsinstruktioner och Knowledge.
